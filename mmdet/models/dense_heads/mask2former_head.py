...
class Mask2FormerHead(MaskFormerHead):
    ...
    def _get_targets_single(self, cls_score: Tensor, mask_pred: Tensor,
        ...
        point_coords = torch.rand((1, self.num_points, 2), device=cls_score.device, dtype=mask_pred.dtype)
        ...
        gt_points_masks = point_sample(
            gt_masks.unsqueeze(1).to(mask_pred.dtype), point_coords.repeat(num_gts, 1,
                                                                           1)).squeeze(1)
