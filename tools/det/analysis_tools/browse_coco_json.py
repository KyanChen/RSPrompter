...
def parse_args():
    ...
    parser.add_argument(
        '--img-dir', default='/Users/kyanchen/codes/lightning_framework/samples/det/levir-ship2/sample_data', help='image folder path')
    parser.add_argument(
        '--ann-file',
        default='/Users/kyanchen/codes/lightning_framework/samples/det/levir-ship2/annotations/sample_test.json',
        help='ann file path')
    parser.add_argument(
