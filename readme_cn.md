...
[项目主页](https://kyanchen.github.io/RSPrompter/) $\cdot$ [PDF下载](https://arxiv.org/abs/2306.16269) $\cdot$ [![论文页面](https://huggingface.co/datasets/huggingface/badges/raw/main/paper-page-sm-dark.svg)]([https://huggingface.co/papers](https://huggingface.co/papers/2306.16269)) $\cdot$ [![HuggingFace Space](https://huggingface.co/datasets/huggingface/badges/raw/main/open-in-hf-spaces-sm-dark.svg)]([https://huggingface.co/spaces](https://huggingface.co/spaces/KyanChen/RSPrompter))
