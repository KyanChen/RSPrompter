...
work_dir = './work_dirs/rsprompter/rsprompter_anchor-ssdd'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-ssdd', group='rsprompter-anchor', name='rsprompter-anchor-ssdd'))
                ]
visualizer = dict(
