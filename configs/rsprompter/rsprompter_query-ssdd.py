...
work_dir = './work_dirs/rsprompter/rsprompter_query-ssdd'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-ssdd', group='rsprompter-query', name='rsprompter-query-ssdd'))
                ]
visualizer = dict(
    type='DetLocalVisualizer', vis_backends=vis_backends, name='visualizer')

num_classes = 1
prompt_shape = (30, 5)  # (per img pointset, per pointset point)
