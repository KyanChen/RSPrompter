default_scope = 'mmdet'
work_dir = './work_dirs/rsprompter/samseg-mask2former'
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=5, max_keep_ckpts=4, save_best='coco/bbox_mAP', rule='greater', save_last=True),
