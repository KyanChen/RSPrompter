...
work_dir = './work_dirs/rsprompter/samseg-mask2former-whu'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-whu', group='samseg-mask2former', name='samseg-mask2former-whu'))
                ]
visualizer = dict(
